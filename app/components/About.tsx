...
export default function About() {
  ...
  return (
    <section id="about" className="page-section relative bg-[#000000] min-h-screen flex items-center border-t border-white/[0.04] overflow-hidden font-mono text-white select-none">
